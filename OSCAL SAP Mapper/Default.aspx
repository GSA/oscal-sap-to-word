<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="OSCAL_SAP_Mapper._Default" %>
   ...
   <script type="text/javascript">
    ...
    <div class="row" onchange ="scrollUp()">
        <div class="col-md-8" runat="server"  >
            <h2>Upload OSCAL SAP XML File</h2>
            <p>
                &nbsp;Browse to the OSCAL Version 1.0.0 SAP XML file and click upload
                to start process.</p>
            <p>
            ...
            <asp:PostBackTrigger ControlID="UploadButton" />
             ...
             <asp:Button ID="OpenMyFile" runat="server" OnClick="OpenMyFile_Click" Text="Download Word SAP Document" Visible="False" />
