...
namespace OSCAL_SAP_Mapper
{
    public partial class _Default : Page
    {
        ...
        public const string SAPschema = "SAP_XML_Template.xml";
        ...
        public string TemplateFile = "FedRAMP-SAP-Mapped.docx";
        ...
        protected void UploadButton_Click(object sender, EventArgs e)
        {
            ...
            if (FileUpload1.HasFile)
            {
                try
                {
                  ...
                  //  PrintProgressBar("", 0);
                    Filename = filename;
                    message = string.Format("Starting the conversion to Word of the OSCAL SAP {0}", filename);
                    percent = 2;
                    ...
                    else
                    {
                      ...
                      /*  myXMLElement = GetXMLElement(filename, "security-sensitivity-level");
                        ...
                        */
                        ...
                        string xmlSchemaPath = HttpContext.Current.Server.MapPath(string.Format(@"~\Template\{0}", SAPschema));
